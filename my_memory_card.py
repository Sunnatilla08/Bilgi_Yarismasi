...
soru1 = Question("Türkiye’de Erozyonla mücadele amacıyla kurulan vakfın kısa adı nedir?","TEMA","EMV","UNICEF","YEŞİLAY")
#soru_sor(soru1)

# 19 Ocak 2022 dersi
soru_listesi = []
soru_listesi.append(soru1)
soru2 = Question("Türkiye’nin uluslararası otomatik telefon kod numarası kaçtır?","90","80","12","70")
soru_listesi.append(soru2)
soru3 = Question("Tarihte ilk yazıyı kimler bulmuştur?","Sümerler","Lidyalılar","Frigyalılar","Antik Yunanlar")
soru4 = Question("Altın Palmiye Ödülleri hangi şehrimizde verilmektedir?","Antalya","Mersin","İzmir","Muğla")
soru5 = Question("Altın Palmiye Ödülleri hangi şehrimizde verilmektedir?","Antalya","Mersin","İzmir","Muğla")
